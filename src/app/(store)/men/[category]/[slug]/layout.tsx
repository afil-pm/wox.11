...
export async function generateMetadata(
  ...
  return generateProductMetadata({
    ...
    gender: product.category?.gender || "men",
...
export default async function ProductLayout({
  ...
  if (product) {
    ...
    const breadcrumbs = generateBreadcrumbSchema([
      ...
      { name: product.category?.gender === "men" ? "Men" : "Boys", url: `${SITE_URL}/${product.category?.gender || "men"}` },
      { name: product.category?.name || "Products", url: `${SITE_URL}/${product.category?.gender || "men"}/${product.category?.slug || "products"}` },
      { name: product.name, url: `${SITE_URL}/${product.category?.gender || "men"}/${product.category?.slug || "products"}/${product.slug}` },
    ]);
