...
const products: Product[] = [
  ...
  },
  {
    ...
    reviewCount: 67,
    images: [
      { url: "/images/products/men/shirts/wox-rust-plaid-flannel-shirt-1.png", alt: "WOX Men's Rust Plaid Flannel Shirt" },
      { url: "/images/products/men/shirts/wox-rust-plaid-flannel-shirt-2.png", alt: "WOX Men's Rust Plaid Flannel Shirt" },
    ],
    category: { name: "Shirts", gender: "men" },
  },
  {
    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <nav className="mb-6 flex items-center gap-2 text-sm text-zinc-500">
          ...
          <ChevronRight className="h-3 w-3" />
          <span className="text-zinc-900">Shirts</span>
        </nav>
