...
const products: Product[] = [
  {
    ...
    salePrice: 1999,
    images: [
      { url: "/images/products/men/shirts/wox-green-plaid-flannel-shirt-1.png", alt: "WOX Men's Green Plaid Flannel Shirt" },
      { url: "/images/products/men/shirts/wox-green-plaid-flannel-shirt-2.png", alt: "WOX Men's Green Plaid Flannel Shirt" },
    ],
    averageRating: 4.8,
    reviewCount: 124,
  ...
  },
  {
    ...
    salePrice: 1899,
    images: [
      { url: "/images/products/men/shirts/wox-brown-plaid-flannel-shirt-1.png", alt: "WOX Men's Brown Plaid Flannel Shirt" },
      { url: "/images/products/men/shirts/wox-brown-plaid-flannel-shirt-2.png", alt: "WOX Men's Brown Plaid Flannel Shirt" },
    ],
    averageRating: 4.7,
    reviewCount: 89,
    category: { name: "Shirts", gender: "men" },
  },
  {
    ...
    salePrice: 1599,
    images: [
      { url: "/images/products/men/shirts/wox-red-plaid-flannel-shirt-1.png", alt: "WOX Men's Red Plaid Flannel Shirt" },
      { url: "/images/products/men/shirts/wox-red-plaid-flannel-shirt-2.png", alt: "WOX Men's Red Plaid Flannel Shirt" },
    ],
    averageRating: 4.5,
    reviewCount: 67,
    category: { name: "Shirts", gender: "men" },
  },
  {
    ...
    salePrice: 999,
    images: [
      { url: "/images/products/men/t-shirts/wox-peach-polo-shirt-1.png", alt: "WOX Men's Peach Polo Shirt" },
      { url: "/images/products/men/t-shirts/wox-peach-polo-shirt-2.png", alt: "WOX Men's Peach Polo Shirt" },
    ],
    averageRating: 4.9,
    reviewCount: 203,
  ...
  },
  {
    ...
    salePrice: 999,
    images: [
      { url: "/images/products/men/t-shirts/wox-wine-polo-shirt-1.png", alt: "WOX Men's Wine Polo Shirt" },
      { url: "/images/products/men/t-shirts/wox-wine-polo-shirt-2.png", alt: "WOX Men's Wine Polo Shirt" },
    ],
    averageRating: 4.6,
    reviewCount: 156,
    category: { name: "T-Shirts", gender: "men" },
  },
  {
    ...
    salePrice: 999,
    images: [
      { url: "/images/products/men/t-shirts/wox-sage-polo-shirt-1.png", alt: "WOX Men's Sage Polo Shirt" },
      { url: "/images/products/men/t-shirts/wox-sage-polo-shirt-2.png", alt: "WOX Men's Sage Polo Shirt" },
    ],
    averageRating: 4.8,
    reviewCount: 92,
    category: { name: "T-Shirts", gender: "men" },
  },
  {
    ...
    salePrice: 1799,
    images: [
      { url: "/images/products/men/pants/wox-khaki-cargo-pants-1.png", alt: "WOX Men's Khaki Cargo Pants" },
      { url: "/images/products/men/pants/wox-khaki-cargo-pants-2.png", alt: "WOX Men's Khaki Cargo Pants" },
    ],
    averageRating: 4.4,
    reviewCount: 78,
  ...
  },
  {
    ...
    salePrice: 1599,
    images: [
      { url: "/images/products/men/pants/wox-navy-formal-chinos-1.png", alt: "WOX Men's Navy Formal Chinos" },
      { url: "/images/products/men/pants/wox-navy-formal-chinos-2.png", alt: "WOX Men's Navy Formal Chinos" },
    ],
    averageRating: 4.7,
    reviewCount: 134,
    category: { name: "Pants", gender: "men" },
  },
  {
    ...
    salePrice: 1999,
    images: [
      { url: "/images/products/men/pants/wox-black-formal-trousers-1.png", alt: "WOX Men's Black Formal Trousers" },
      { url: "/images/products/men/pants/wox-black-formal-trousers-2.png", alt: "WOX Men's Black Formal Trousers" },
    ],
    averageRating: 4.6,
    reviewCount: 187,
    category: { name: "Pants", gender: "men" },
