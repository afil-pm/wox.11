...
const products: Product[] = [
  ...
  },
  {
    ...
    reviewCount: 134,
    images: [
      { url: "/images/products/men/pants/wox-black-cargo-pants-1.png", alt: "WOX Men's Black Cargo Pants" },
      { url: "/images/products/men/pants/wox-black-cargo-pants-2.png", alt: "WOX Men's Black Cargo Pants" },
    ],
    category: { name: "Pants", gender: "men" },
  },
  {
  ...
  },
  {
    ...
    reviewCount: 62,
    images: [
      { url: "/images/products/men/pants/wox-olive-casual-chinos-1.png", alt: "WOX Men's Olive Casual Chinos" },
    ],
    category: { name: "Pants", gender: "men" },
  },
];
    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <nav className="mb-6 flex items-center gap-2 text-sm text-zinc-500">
          ...
          <ChevronRight className="h-3 w-3" />
          <span className="text-zinc-900">Pants</span>
        </nav>
