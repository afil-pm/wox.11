...
const products: Product[] = [
  {
    ...
    basePrice: 1299,
    salePrice: 999,
    images: [{ url: "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=600&h=800&fit=crop&auto=format", alt: "Young Classic Shirt" }],
    averageRating: 4.5,
    reviewCount: 42,
  ...
  },
  {
    ...
    basePrice: 999,
    salePrice: 799,
    images: [{ url: "https://images.unsplash.com/photo-1624835567150-0c530a20d8cc?w=600&h=800&fit=crop&auto=format", alt: "Kids Casual Shirt" }],
    averageRating: 4.3,
    reviewCount: 35,
    category: { name: "Shirts", gender: "boys" },
  },
  {
    ...
    basePrice: 1199,
    salePrice: 899,
    images: [{ url: "https://images.unsplash.com/photo-1594938291221-94f18cbb5660?w=600&h=800&fit=crop&auto=format", alt: "School Formal Shirt" }],
    averageRating: 4.6,
    reviewCount: 58,
    category: { name: "Shirts", gender: "boys" },
  },
  {
    ...
    basePrice: 799,
    salePrice: 599,
    images: [{ url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&h=800&fit=crop&auto=format", alt: "Young Essential Tee" }],
    averageRating: 4.4,
    reviewCount: 67,
  ...
  },
  {
    ...
    basePrice: 699,
    salePrice: 499,
    images: [{ url: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=600&h=800&fit=crop&auto=format", alt: "Kids Graphic Tee" }],
    averageRating: 4.2,
    reviewCount: 45,
    category: { name: "T-Shirts", gender: "boys" },
  },
  {
    ...
    basePrice: 899,
    salePrice: 699,
    images: [{ url: "https://images.unsplash.com/photo-1602810320073-1230c46d89d4?w=600&h=800&fit=crop&auto=format", alt: "Sports Active Tee" }],
    averageRating: 4.5,
    reviewCount: 38,
    category: { name: "T-Shirts", gender: "boys" },
  },
  {
    ...
    basePrice: 1599,
    salePrice: 1299,
    images: [{ url: "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&h=800&fit=crop&auto=format", alt: "Young Slim Fit Jeans" }],
    averageRating: 4.7,
    reviewCount: 29,
  ...
  },
  {
    ...
    basePrice: 1299,
    salePrice: 999,
    images: [{ url: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=600&h=800&fit=crop&auto=format", alt: "Kids Comfort Joggers" }],
    averageRating: 4.4,
    reviewCount: 52,
    category: { name: "Pants", gender: "boys" },
  },
  {
    ...
    basePrice: 1499,
    salePrice: 1199,
    images: [{ url: "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&h=800&fit=crop&auto=format", alt: "School Formal Pants" }],
    averageRating: 4.6,
    reviewCount: 33,
    category: { name: "Pants", gender: "boys" },
  },
