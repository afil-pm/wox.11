...
export default function BoysPage() {
  ...
  useEffect(() => {
    fetch("/api/products/listing?gender=boys")
      .then((r) => r.json())
    ...
    <div className="min-h-screen bg-white">
      <div className="border-b border-zinc-200 bg-zinc-50">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-zinc-500">Quality clothing for boys aged 4–15</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 text-sm text-zinc-500">{filteredProducts.length} products</p>
