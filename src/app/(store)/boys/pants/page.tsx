...
const products: Product[] = [
  ...
  },
  {
    ...
    reviewCount: 78,
    images: [
      { url: "/images/products/boys/pants/wox-boys-light-blue-jeans-1.png", alt: "WOX Boys' Light Blue Wide-Leg Jeans" },
      { url: "/images/products/boys/pants/wox-boys-light-blue-jeans-2.png", alt: "WOX Boys' Light Blue Wide-Leg Jeans" },
    ],
    category: { name: "Pants", gender: "boys" },
  },
  {
    ...
    reviewCount: 65,
    images: [
      { url: "/images/products/boys/pants/wox-boys-white-wide-leg-1.png", alt: "WOX Boys' White Wide-Leg Pants" },
      { url: "/images/products/boys/pants/wox-boys-white-wide-leg-2.png", alt: "WOX Boys' White Wide-Leg Pants" },
    ],
    category: { name: "Pants", gender: "boys" },
  },
];
